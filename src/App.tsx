    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Transaction Status Dashboard</h1>
        ...
        {error && (
          <div className="max-w-6xl mx-auto mt-4 p-4 bg-red-50 rounded-lg border border-red-200">
